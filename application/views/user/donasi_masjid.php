<div class="card">
  ...
  <!-- end carousel -->
        ...
        <div class="col-8 text-center text-white">
          ...
          <div class="btn btn-primary btn-lg btn-block">
          <div class="row">
              <div class="col-10 text-left">Bayar lewat transfer bank melalui rekening berikut ini: <br> BNI norek (nama)</div>
              <div class="col-2"><img src="<?= base_url('assets/images/2.png'); ?>" class="float-left"></div>
            </div>
          </div>
          <div class="btn btn-primary btn-lg btn-block">
            <div class="row">
              <div class="col-2"><img src="<?= base_url('assets/images/3.png'); ?>" class="float-left"></div>
              <div class="col-10 text-left">Berdonasi melalui kotak amal yang telah disebar di tiap sudut kampus <br>-lobby gedung d <br>-lobby gedung e</div>
            </div>
          </div>
          <div class="btn btn-primary btn-lg btn-block">
            <div class="row">
              <div class="col-10 text-left">Menggunakan platform donasi online pada link berikut ini: <br><a href="https://kitabisa.com/campaign/bangunbaim">kitabisa.com</a></div>
              <div class="col-2"><img src="<?= base_url('assets/images/4.png'); ?>" class="float-left"></div>
            </div>
          </div>  
        </div>
