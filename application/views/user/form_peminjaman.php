  ...
  <div class="card text-white">
    ...
    <div class="container">
      <form action="<?= base_url('Form_peminjaman/addDataBaru'); ?>" method="post">
        ...
        <div class="form-group row">
          <label class="col-lg-2 col-form-label">Penyelenggara Kegiatan</label>
          <div class="col-lg-10">
            <input type="text" class="form-control" name="penyelenggara">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-lg-2 col-form-label">Penanggung Jawab Kegiatan</label>
          <div class="col-lg-10">
        ...
        <div class="form-group row">
          <label class="col-lg-2 col-form-label">Jaminan</label>
          <div class="col-lg-10">
            <input type="text" class="form-control" name="jaminan">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-lg-2 col-form-label">Lokasi Alat Digunakan</label>
          <div class="col-lg-10">
        ...
        <div class="row">
          <div class="col">
            <div class="form-group row">
              <label class="col-lg-4 col-form-label">Tanggal Penyewaan</label>
              <div class="col-lg-8">
          ...
          <div class="col">
            <div class="form-group row">
              <label class="col-lg-4 col-form-label">Tanggal Pengembalian</label>
              <div class="col-lg-8">
